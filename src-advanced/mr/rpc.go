...
/*
	...
	TaskType
	WorkerAddress: Workers report their listening address
*/
...
/*
	...
	MapTaskLocations: A list contains addresses of the workers who did the corresponding Map work
*/
